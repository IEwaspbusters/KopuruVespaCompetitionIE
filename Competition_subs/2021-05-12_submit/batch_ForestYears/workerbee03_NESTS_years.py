...
WBds01 = 'https://raw.githubusercontent.com/IEwaspbusters/KopuruVespaCompetitionIE/main/Competition_subs/2021-05-12_submit/batch_ForestYears/WBds01_GEO.csv?token=ATVGE4N2B2UILI7TNPPUIODATQHXE'
WBds02 = 'https://raw.githubusercontent.com/IEwaspbusters/KopuruVespaCompetitionIE/main/Competition_subs/2021-05-12_submit/batch_ForestYears/WBds02_METEO.csv?token=ATVGE4I3QDFBO3AEI2M2443ATQHYW'
...
pred_temp = 'https://raw.githubusercontent.com/IEwaspbusters/KopuruVespaCompetitionIE/main/Other_open_data/predict_template_years.csv?token=ATVGE4O3XZBAJWPOB3ZCGDDATQJ74'
downloadpred_temp = github_session.get(pred_temp).content

# Reading the downloaded content and making it a pandas dataframe
df_temp = pd.read_csv(io.StringIO(downloadpred_temp.decode('utf-8')), sep=",", header=0)
