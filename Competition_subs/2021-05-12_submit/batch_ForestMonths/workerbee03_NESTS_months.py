...
Script to create the monthly train and predict datasets (csv files) for the May 12, 2021 submission
...
pred_temp = 'https://raw.githubusercontent.com/IEwaspbusters/KopuruVespaCompetitionIE/main/Other_open_data/predict_template.csv?token=ATVGE4O25MVTIF2G7EB3ZTLATFTAU'
